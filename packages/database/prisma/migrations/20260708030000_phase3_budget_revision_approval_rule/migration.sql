...
SELECT
  ...
  100,
  true,
  '{"source":"phase3_budget_revision_approval_rule","appliesTo":"non_posting_budget_revision_approval"}'::jsonb
FROM "Company" c
WHERE NOT EXISTS (
  SELECT 1
  ...
  WHERE ar."tenantId" = c."tenantId"
    ...
    AND ar."transactionType" = 'BudgetRevision'
...
WHERE ar."transactionType" = 'BudgetRevision'
  AND ar."isActive" = true
  AND NOT EXISTS (
    SELECT 1
