...
SELECT
  ...
  100,
  true,
  '{"source":"phase3_expense_request_approval_rule","appliesTo":"non_posting_expense_request_approval"}'::jsonb
FROM "Company" c
WHERE NOT EXISTS (
  SELECT 1
  ...
  WHERE ar."tenantId" = c."tenantId"
    ...
    AND ar."transactionType" = 'ExpenseRequest'
...
WHERE ar."transactionType" = 'ExpenseRequest'
  AND ar."isActive" = true
  AND NOT EXISTS (
    SELECT 1
