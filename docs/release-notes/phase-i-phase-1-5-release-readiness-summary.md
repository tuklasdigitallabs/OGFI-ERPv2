...
- Organization Scope Brands now uses selected-company server filters, deterministic pagination, and a bounded active brand catalog for location creation. Department dependency counts remain pending a separate contract and release gate.
