...
| SPF-002 | Migration and data-safety verification | Review all pending migrations, deploy them to a disposable environment, compare pre/post snapshots, and verify rollback considerations | Reopened for corrective migration `20260721200000_project_requirement_attachment_context`; review and local database validation pass, exact-SHA predecessor rehearsal and evidence update pending |
