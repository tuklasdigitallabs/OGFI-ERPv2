...
| Authentication | Session-based application authentication using Auth.js-compatible server sessions | Implement custom ERP roles and scopes; do not delegate authorization to frontend routes. Password handling must use an approved strong password hashing implementation. |
