...
| Entity                   | Required fields                                                                                                                                                                                                                                                                              | Notes                                                                                                                                                                                                                                                                |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Supplier Quote           | `company_id`, `rfq_number`, `supplier_id`, `request_date`, `currency_code`, `status`, `subtotal_amount`, `tax_amount`, `discount_amount`, `freight_amount`, `other_charges_amount`, `supplier_accreditation_snapshot`, `idempotency_key`, `idempotency_request_hash` | Captures quote reference, validity, lead time, terms, commercial components, and supplier snapshot. Total is server-calculated in company currency. Binary attachments remain deferred pending the controlled-evidence matrix. |
