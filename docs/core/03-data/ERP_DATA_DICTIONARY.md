...
| Entity                   | Required fields                                                                                                                                                                                                                                                                              | Notes                                                                                                                                                                                                                                                                |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Supplier Quote           | `company_id`, `rfq_number`, `supplier_id`, `request_date`, `currency_code`, `status`, `idempotency_key`, `idempotency_request_hash`                                                                                                                                                       | Captures quote reference, validity, lead time, terms, charges, attachment. The idempotency key is unique within tenant/company when present; the request hash is a canonical retry-safety fingerprint.                                                                 |
