...
| 2 | Receiving | Critical | Draft receipt creation shows multiple full PO forms in one modal. |
...
| 7 | Quotes | High | Quote comparison is vertically stacked instead of focused. |
