...
- Operational dashboards must surface food-cost health counts from the authoritative food-cost analysis service, not recompute incompatible definitions in the dashboard layer.
