# OGFI ERP — Phase IV Workflow: Post-Opening Review

**Status:** Planned detailed-specification framework  
**Purpose:** Review first 30/60/90 days against feasibility, capex, staffing and operational assumptions.
...
Use `../implementation/PHASE4_DECISION_REGISTER.md` to record phase-specific policy decisions before this workflow is marked build-ready.
