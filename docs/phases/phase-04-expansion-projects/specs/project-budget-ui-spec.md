# OGFI ERP — Phase IV UI Specification: Project Budget
...
Provide a role-aware workspace for project budget while preserving company, brand, location/project, department, requester, status, approval and audit context.
