# OGFI ERP — Phase IV UI Specification: Expansion Dashboard
...
Provide a role-aware workspace for expansion dashboard while preserving company, brand, location/project, department, requester, status, approval and audit context.
