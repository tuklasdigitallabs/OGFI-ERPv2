# OGFI ERP — Phase IV UI Specification: Site Pipeline
...
Provide a role-aware workspace for site pipeline while preserving company, brand, location/project, department, requester, status, approval and audit context.
