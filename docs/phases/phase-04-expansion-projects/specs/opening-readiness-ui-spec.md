# OGFI ERP — Phase IV UI Specification: Opening Readiness
...
Provide a role-aware workspace for opening readiness while preserving company, brand, location/project, department, requester, status, approval and audit context.
