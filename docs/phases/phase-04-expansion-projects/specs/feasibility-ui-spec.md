# OGFI ERP — Phase IV UI Specification: Feasibility Workspace
...
Provide a role-aware workspace for feasibility workspace while preserving company, brand, location/project, department, requester, status, approval and audit context.
