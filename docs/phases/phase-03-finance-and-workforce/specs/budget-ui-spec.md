# OGFI ERP — Phase III UI Specification: Budget Management
...
Provide a role-aware workspace for budget management while preserving company, brand, location/project, department, requester, status, approval and audit context.
