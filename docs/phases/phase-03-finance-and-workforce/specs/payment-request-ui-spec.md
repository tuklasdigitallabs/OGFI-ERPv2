# OGFI ERP — Phase III UI Specification: Payment Requests
...
Provide a role-aware workspace for payment requests while preserving company, brand, location/project, department, requester, status, approval and audit context.
