# OGFI ERP — Phase III UI Specification: Finance Workspace
...
Provide a role-aware workspace for finance workspace while preserving company, brand, location/project, department, requester, status, approval and audit context.
