# OGFI ERP — Phase III UI Specification: HR and Workforce
...
Provide a role-aware workspace for hr and workforce while preserving company, brand, location/project, department, requester, status, approval and audit context.
