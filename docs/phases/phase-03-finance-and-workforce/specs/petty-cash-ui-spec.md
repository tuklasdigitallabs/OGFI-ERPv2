# OGFI ERP — Phase III UI Specification: Petty Cash
...
Provide a role-aware workspace for petty cash while preserving company, brand, location/project, department, requester, status, approval and audit context.
