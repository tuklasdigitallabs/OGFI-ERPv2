# OGFI ERP — Phase III UI Specification: Scheduling and Manpower
...
Provide a role-aware workspace for scheduling and manpower while preserving company, brand, location/project, department, requester, status, approval and audit context.
