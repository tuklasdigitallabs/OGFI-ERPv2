# OGFI ERP — Phase V UI Specification: Integration Settings
...
Provide a role-aware workspace for integration settings while preserving company, brand, location/project, department, requester, status, approval and audit context.
