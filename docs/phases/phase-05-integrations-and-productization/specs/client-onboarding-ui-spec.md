# OGFI ERP — Phase V UI Specification: Client Onboarding
...
Provide a role-aware workspace for client onboarding while preserving company, brand, location/project, department, requester, status, approval and audit context.
