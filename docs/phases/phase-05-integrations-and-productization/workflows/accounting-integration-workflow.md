# OGFI ERP — Phase V Workflow: Accounting Integration

**Status:** Planned detailed-specification framework  
**Purpose:** Export or synchronize approved purchasing, receiving, expenses and payment data to finance systems.
...
Use `../implementation/PHASE5_DECISION_REGISTER.md` to record phase-specific policy decisions before this workflow is marked build-ready.
