...
For a recorded item that was not created by you, choose **Open review controls** to open one focused review sheet. Verify confirms the evidence; Reject requires a reason of at least five characters. The sheet preserves the active filters and page after the action.
