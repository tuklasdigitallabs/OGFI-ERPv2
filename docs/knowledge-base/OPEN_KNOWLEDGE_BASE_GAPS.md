...
| 2026-07-22 | Multi-step approval and outcome notifications | Resolved: the data dictionary and Phase I backlog now match the implemented bounded in-app behavior. Intermediate approval keeps the source pending and notifies only eligible next-step approvers; final approval, return, or rejection notifies the requester or responsible owner. Scheduled, external, and broader fanout remain deferred. | `approvals-ui-spec.md`; `purchasing-workflow.md`; `ERP_DATA_DICTIONARY.md`; `PHASE1_BUILD_BACKLOG_AND_ACCEPTANCE_CRITERIA.md`; implemented `approvals.ts` | Approvers, requesters/owners, Purchasing, Operations, inventory users, administrators | Mithi / Dunong | Resolved |
