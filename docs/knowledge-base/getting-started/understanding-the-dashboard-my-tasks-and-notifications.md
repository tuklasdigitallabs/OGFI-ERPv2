...
3. Open `My Tasks` when you need the current paginated operational action queue. It presently includes eligible Transfer, Wastage, and Stock Adjustment actions only.
