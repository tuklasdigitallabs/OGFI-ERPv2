...
const collectionGroups = [
  ...
  group(
    ...
    [
      ...
      "UNAVAILABLE: DEC-0248 same-fence rollback/recovery",
    ...
    [
      ...
      "future DEC-0248 same-fence rollback/recovery artifact (unavailable)",
      "future DEC-0248 authoritative post-rollback smoke artifact (unavailable)",
...
const lines = [
  ...
  "EXTERNAL | Backup restore | requires a real dump/checksum/isolated restore plus future DEC-0248 same-fence rollback/recovery and authoritative target smoke; legacy summaries receive no credit.",
