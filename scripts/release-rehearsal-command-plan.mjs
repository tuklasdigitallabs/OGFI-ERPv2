...
const lines = [
  ...
  "STEP | 13 | Release Manager / DevOps Owner | BLOCKED — DEC-0248 same-fence rollback/recovery is not implemented.",
  "COMMAND | UNAVAILABLE | Legacy release:rollback-summary exits 78 and manual metadata receives no release credit.",
  "ARTIFACT | UNAVAILABLE | Future root-owned release service rollback/recovery journal evidence.",
  "STEP | 14 | QA Lead / Release Manager | BLOCKED — authoritative post-rollback cutover/smoke is not implemented.",
  "COMMAND | UNAVAILABLE | Ordinary release:smoke output cannot prove the authoritative rollback target.",
  "ARTIFACT | UNAVAILABLE | Future DEC-0248 authoritative post-rollback smoke evidence.",
  ...
  "",
  "Safeguards",
  "SAFEGUARD | DEC-0248 hosted release authority is unavailable; this generated plan cannot clear final review or GO / NO-GO.",
