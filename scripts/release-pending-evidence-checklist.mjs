...
const groups = [
  ...
  },
  {
    ...
    commands: [
      ...
      "UNAVAILABLE: DEC-0248 same-fence rollback/recovery command is not implemented",
    ...
    steps: [
      ...
      "Keep rollback evidence blocked until the DEC-0248 same-fence rollback/recovery path is implemented and accepted.",
      "Do not generate a manual rollback summary or use ordinary smoke output as rollback execution evidence.",
    ...
    artifacts: [
      ...
      "DEC-0248 same-fence rollback/recovery artifact (unavailable)",
      "DEC-0248 authoritative post-rollback smoke artifact (unavailable)",
    ...
    acceptance:
      "A real backup dump and restore verification are collected, and the implemented DEC-0248 service supplies accepted same-fence rollback/recovery and authoritative smoke proof. Legacy summaries and ordinary smoke do not satisfy this gate.",
  },
  {
...
const lines = [
  ...
  "Run pnpm release:rehearsal-plan for diagnostic sequencing only; rollback and final gates remain explicitly blocked by DEC-0248.",
  "",
];
