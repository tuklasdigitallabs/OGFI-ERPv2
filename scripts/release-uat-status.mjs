...
const lines = [
  ...
  "OWNER | severity=Critical | owner=Finance Owner / Workforce Owner / QA Lead | evidence=use the dedicated Phase 3 UAT status and Release Readiness register for verified Phase 3 coverage",
  "WORKFLOW | Phase 3 finance controlled foundation",
  "WORKFLOW | Phase 3 workforce controlled foundation",
  "WORKFLOW | Phase 3 deferred blocker review",
  "NOTE | These labels are included for umbrella release-status traceability only; this Phase I / Phase 1.5 status report does not verify Phase 3 UAT execution.",
  "",
