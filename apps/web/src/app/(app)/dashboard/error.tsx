...
export default function DashboardError({ reset }: { reset: () => void }) {
  return (
    <section
      ...
      role="alert"
    >
      <h2 className="font-semibold">Company overview could not be loaded.</h2>
      <p className="mt-1">
        Your operational records have not been changed. Try again, or contact support if the problem continues.
      </p>
      <button
