      ...
      <div className="space-y-4">
        {canCreateDraft ? (
          <div className="flex justify-end">
            <TaskSheet title="Create Draft PR" description="Build and review request lines before creating the draft." header={<div className="grid gap-2 border-t border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-600 sm:grid-cols-4"><div><span className="block font-semibold uppercase tracking-wide text-slate-500">Company</span><span className="font-bold text-slate-900">{session.context.companyName}</span></div><div><span className="block font-semibold uppercase tracking-wide text-slate-500">Brand</span><span className="font-bold text-slate-900">{session.context.brandName}</span></div><div><span className="block font-semibold uppercase tracking-wide text-slate-500">Location</span><span className="font-bold text-slate-900">{session.context.locationName}</span></div><div><span className="block font-semibold uppercase tracking-wide text-slate-500">Requester</span><span className="font-bold text-slate-900">{session.user.displayName}</span></div></div>} trigger={<span>Create Purchase Request</span>} triggerClassName="min-h-11 bg-blue-600 px-4 text-sm font-semibold text-white hover:bg-blue-700" size="workspace" bodyScroll="contained" bodyClassName="p-0">
