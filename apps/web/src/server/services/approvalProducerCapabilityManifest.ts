...
const currentTransactionFacts = {
  ...
  CashAdvanceRequest: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Scoped source is read in the transaction and updated by id with version increment; no capability-bound replay proof exists." },
  PettyCashRequest: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Scoped source is read in the transaction and updated by id; no capability-bound replay proof exists." },
  PaymentRequest: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Scoped source is read in the transaction and updated by id; pending uniqueness is a backstop, not an exact replay contract." },
  ...
  EmployeeLeaveRequest: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Scoped source is read and updated by id; SUBMITTED returns are source-only and not graph-contract proof." },
  EmployeeOvertimeRecord: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Scoped source is read and updated by id; SUBMITTED returns are source-only and not graph-contract proof." },
  WorkforceSchedule: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Scoped source is read and updated by id; no exact capability-bound replay exists." },
  AttendanceImportBatch: { lock: "ABSENT", cas: "PARTIAL", replay: "ABSENT", fact: "Approval-required review reads then updates the batch by id; the conditional non-approval branch is not a graph producer." },
