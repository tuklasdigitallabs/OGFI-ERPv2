...
const policyList: readonly ApprovalRoutingPolicy[] = [
  ...
  { documentType: "OpeningInventoryCutover", requiredPermissionCode: permissions.openingInventoryOperationsReview, allowedSourceStatuses: ["PENDING_APPROVAL"], scopeSource: "locationId", dueSource: "NONE", prohibitedActorSources: ["requestedByUserId:REQUESTER", "reviewedByUserId:PREPARER"] },
  ...
  { documentType: "BudgetRevision", requiredPermissionCode: permissions.financeBudgetApprove, allowedSourceStatuses: ["SUBMITTED", "UNDER_REVIEW"], scopeSource: "budget.locationId+budget.lines.locationId-or-company", dueSource: "effectiveFrom", prohibitedActorSources: ["requestedByUserId:REQUESTER"] },
